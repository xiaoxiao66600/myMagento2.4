...
class AccountManagement implements AccountManagementInterface
{
     ...
     */
    public function createAccountWithPasswordHash(\Codilar\Customer\Api\Data\CustomerInterface $customer, $hash, $redirectUrl = '')
    {
     ...
     * @throws NoSuchEntityException
     */
    protected function sendEmailConfirmation(\Codilar\Customer\Api\Data\CustomerInterface $customer, $redirectUrl)
    {
        try {
